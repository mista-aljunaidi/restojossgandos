        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
            ...
            <div class="order-2 lg:order-2">
                <div class="relative mt-12 mb-8">
                    <div class="bg-gradient-to-br from-red-100 to-orange-100 rounded-3xl p-8">
    ...
    <div class="swiper testimonialSwiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl shadow-lg p-8 text-left hover:shadow-xl transition-shadow duration-300">
            <!-- Stars -->
        ...
        <!-- Testimonial 2 -->
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl shadow-lg p-8 text-left hover:shadow-2xl transition-shadow duration-300">
            <div class="flex text-yellow-400 mb-4">
              <span>★★★★★</span>
            </div>
            <p class="text-gray-600 mb-6">
