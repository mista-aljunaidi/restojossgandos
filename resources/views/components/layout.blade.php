  ...
  <footer class="bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 shadow-lg text-black">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-16 lg:gap-32">
            ...
            <!-- Company Info -->
            <div>
                <h3 class="text-xl font-bold bg-gradient-to-l from-red-900 to-orange-600 bg-clip-text text-transparent mb-4">Resto Joss Gandos</h3>
                ...
                <div class="flex space-x-4 text-lg">
                    ...
                    <a href="https://www.instagram.com/restojossgandos/" class="hover:text-red-400 transition"><span class="[&>svg]:h-5 [&>svg]:w-5">
                    ...
                    <a href="https://www.tiktok.com/@restojossgandos" class="hover:text-red-400 transition"><span class="[&>svg]:h-5 [&>svg]:w-5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="/" onclick="showPage('home')" class="hover:text-red-400 transition">Home</a></li>
                    <li><a href="about" onclick="showPage('about')" class="hover:text-red-400 transition">Tentang Kami</a></li>
                    <li><a href="menu" onclick="showPage('menu')" class="hover:text-red-400 transition">Menu</a></li>
                    <li><a href="gallery" onclick="showPage('gallery')" class="hover:text-red-400 transition">Galeri</a></li>
                    <li><a href="location" onclick="showPage('lokasi')" class="hover:text-red-400 transition">Lokasi</a></li>
                </ul>
            </div>
            ...
            <h4 class="font-bold mb-4">Kontak</h4>
              <ul class="space-y-2">
                <li class="flex items-center gap-2">
                  ...
                  Jl. Raya Jemursari No.15, Kec. Wonocolo, Surabaya, Jawa Timur
                </li>
                <li class="flex items-center gap-2">
